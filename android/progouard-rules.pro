...
-dontoptimize
-dontpreverify
-keeppackagenames my.com.softspace.SSMobileMPOSCore.* -keeppackagenames my.com.softspace.SSMobileAndroidUtilEngine.* -keeppackagenames my.com.softspace.SSMobileUIComponent.* -keeppackagenames my.com.softspace.SSMobileUtilEngine.* -keeppackagenames my.com.softspace.SSMobileServiceEngine.* -keeppackagenames my.com.softspace.SSMobileHttpEngine.* -keeppackagenames my.com.softspace.configuration.*
-keeppackagenames my.com.softspace.SSMobileReaderEngine.* -keepattributes Exceptions,InnerClasses,Signature,Deprecated,*Annotation*,EnclosingMethod -dontwarn android.**
-dontwarn kotlinx.** -dontwarn rx.** -dontwarn okio.** -dontwarn com.** -dontwarn org.**


# ===== KEEP ALL third party package =====
# keep for android support library -keep class android.**{*;}
-keep interface android.**{*;}
# keep for android google sdk -keep class com.google.**{*;} -keep interface com.google.**{*;}
# keep for mozilla checkdigit feature -keep class org.**{*;}
-keep interface org.**{*;}
...
-dontwarn javax.annotation.ParametersAreNonnullByDefault -keep class okio.**{*;}
-keep interface okio.**{*;}
-keep class okhttp3.**{*;}
...
<fields>;
public <methods>; }
-keep public class my.com.softspace.SSMobileMPOSCore.service.dao.** { <fields>;
public <methods>; }
...
<fields>;
public <methods>; }
-keep public class my.com.softspace.SSMobileServiceEngine.dao.** { <fields>;
public <methods>; }
...
assumenosideeffects class android.util.Log { *; } -dontwarn my.com.softspace.auditlog.**
